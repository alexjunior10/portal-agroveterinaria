      ...
      <aside className="w-full md:w-64 bg-andes-dark text-white flex flex-col md:sticky md:top-0 h-screen">
        ...
        <div className="p-4 border-t border-andes/50">
          <button 
            ...
            className="flex items-center justify-center gap-2 px-4 py-2.5 w-full rounded-lg font-semibold text-red-400 bg-red-400/10 hover:bg-red-500 hover:text-white transition-all border border-red-500/20 shadow-sm"
          >
